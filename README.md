...
- in Ubuntu 18.04 environment you can try [x86-64 package](https://github.com/asimba/pybpgviewer/releases/download/v1.28/bpgviewer-1.28-ubuntu-18.04-amd64.deb).  
